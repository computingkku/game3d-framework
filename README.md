...
## การอ้างอิงทรัพยากร (Assets)
- ทรัพยากรบางส่วนที่ใช้ในโปรเจกต์พัฒนามาจากผลงานของ Kay Lousberg (itch.io): https://kaylousberg.itch.io/
  - การใช้งานเป็นไปตามเงื่อนไข/สัญญาอนุญาตของผู้สร้าง กรุณาตรวจสอบข้อกำหนดที่ระบุในหน้าแพ็กหรือไฟล์กำกับของแต่ละชุดทรัพยากร
  - หากมีการเผยแพร่ต่อ ควรรักษาการอ้างอิงและเงื่อนไขตามที่ผู้สร้างกำหนดไว้
